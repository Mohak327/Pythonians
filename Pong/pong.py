...
class ball():
	...
	def draw(self):
		pygame.draw.circle(screen, lime, (self.rect.x + self.ball_rad, self.rect.y + self.ball_rad), self.ball_rad)
	...
	def reset(self, x, y):
		...
		self.speed_x = -4
		self.speed_y = 4
		self.winner = 0# 1 is the player and -1 is the AI
...
while run:
	...
	draw_text('HI: ' + str(player_score), font, white, screen_width - 100, 15)
